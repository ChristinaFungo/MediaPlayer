...
public class MusicAdapter extends RecyclerView.Adapter<MusicAdapter.MusicViewHolder> {
    ...
    private List<com.khrystynahryb.mediaplayer.Music> musicList;
    private OnMusicClickListener musicClickListener;

    public MusicAdapter(List<com.khrystynahryb.mediaplayer.Music> musicList, OnMusicClickListener musicClickListener){
    ...
    public class MusicViewHolder extends RecyclerView.ViewHolder{
        ...
        public void bindMusic(com.khrystynahryb.mediaplayer.Music music){
    ...
    public  void notifyMusicChange(com.khrystynahryb.mediaplayer.Music music){
    ...
    public  interface OnMusicClickListener{
        void onClick(com.khrystynahryb.mediaplayer.Music music, int position);
    }
}
